public class Main {
    public static void main(String[] args) {
        ...
        Event event3 = new Event("L1", 300,8,10);
        Event event4 = new Event("L2", 30,8,10);
        Event event5 = new Event("L3", 30,10,12);

        Room room1 = new Room("401", 30,RoomType.LABORATORY);
        Room room2 = new Room("403", 30, RoomType.LABORATORY);
        Room room3 = new Room("405", 30, RoomType.LABORATORY);
        Room room4 = new Room("309", 100,RoomType.LECTURE_HALL);
