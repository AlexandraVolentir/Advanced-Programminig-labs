...
public class Person {
    ...
    @JoinTable(name = "FRIENDS", joinColumns = @JoinColumn(name = "FIRSTFRIENDID", referencedColumnName = "Id", nullable = false), inverseJoinColumns = @JoinColumn(name = "SECONDFRIENDID", referencedColumnName = "Id", nullable = false))
