...
public class Server {
    ...
    public void sendMessageTo(String recipient, String receiver, String message) {
        for(ThreadHandler threadHandler: threadHandlerList) {
            if(threadHandler.getName().equals(receiver)) {
                threadHandler.receiveMessage(recipient, message);
            }
        }
    }
